...
//        String example = "hjksdhsdjhfjksdfhsdkhf";
...
//        System.out.println("Text Decryted : " + s);
        ...
        String str = "hola como estas? asbdhadkjas askldjald akldjalkdas ";
        String result = "";
        ...
        for (String s : result.split(" ")) { //los numeros estan separados por espacios
